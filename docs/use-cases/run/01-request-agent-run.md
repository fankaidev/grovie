...
| UC-RUN-01-S05 | P1 | Follow-up run prompts include only effective issue activity since the previous handled cursor, while `.grovie/task.json` keeps the complete structured context. |
