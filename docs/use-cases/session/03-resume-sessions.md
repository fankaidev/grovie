# UC-SESSION-03: Resume Work Across Daemon Stop and Start
...
|----|----------|----------|
| UC-SESSION-03-S01 | P0 | Graceful daemon stop marks active runs interrupted and resumable before terminating the daemon process. |
